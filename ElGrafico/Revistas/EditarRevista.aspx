<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarRevista.aspx.cs" Inherits="ElGrafico.Revistas.EditarRevista" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary" id="form">
        <div class="panel-heading">
            <h2 class="panel-title">Editar Revista</h2>
        </div>

        <div class="row clearfix">
            <div class="col-md-4 column">
                <asp:Image ID="imgTapa" class="img-thumbnail" Width="350" Height="500" runat="server" />
            </div>
            ...
            <div class="col-md-8 column">
                ...
                <div class="form-group">
                    <b>
                        <asp:Label ID="Label1" runat="server" Text="Subir Tapa" class="col-sm-2 control-label">      
                        </asp:Label></b>
                    <div class="col-md-3">
